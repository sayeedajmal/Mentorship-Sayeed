...
<div class="green">
    ...
    <input class="skills_ofLegends" type="button" value="Skills Of Legend Devs.">
    <div class="skills">
        <h4 class="Why_skills">Why We Need Skills</h4>
        <h6 class="Programing_skills">We’re the best in the skills.</h6>
        <h4 class="lead_time">First, solve the problem. Then, write the code.<br>Make it work, make it right, make it fast.</h4>
        <div class="about_column">
            <img class="icons" src="https://assets.website-files.com/5e7ff3ec0c4ef4c974fa99e3/5e84b9ccd071025d67c7e431_verified.svg">
            <h6 class="Programing_skills">Programming with Java</h6>
        ...
        <div class="about_column">
            ...
            <h6 class="Programing_skills">RealTime Experience</h6>
            <h4 class="discriptions">Will Try! to Replace Here! Some thing!</h4>
        </div>
        <div class="about_column">
